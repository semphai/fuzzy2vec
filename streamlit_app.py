...
st.set_page_config(
    page_title="Working at Height Risk Assessment System",
    layout="centered"
)
...
scenarios = [
    ...
    {"name": "Scenario 4 - Storm and heavy rain, no harness",
    ...
    {"name": "Scenario 6 - New worker, indoor conditions",
     "wind":20, "temp":22, "age":21, "humidity":75, "rain":60, "health":0.5, "belt":True},

    {"name": "Scenario 7 - Worker with health issues",
     "wind":8, "temp":28, "age":50, "humidity":95, "rain":20, "health":3.5, "belt":True},

    {"name": "Scenario 8 - Storm conditions, no harness",
     "wind":78, "temp":18, "age":38, "humidity":40, "rain":80, "health":1.0, "belt":False},

    {"name": "Scenario 9 - Experienced worker, controlled environment",
     "wind":9, "temp":20, "age":48, "humidity":55, "rain":75, "health":2.0, "belt":True},

    {"name": "Scenario 10 - Middle aged worker, humid air",
     "wind":14, "temp":10, "age":35, "humidity":65, "rain":0, "health":2.5, "belt":True},
]

selected_scenario = st.selectbox(
    "Select a predefined scenario (optional)",
...
if selected_scenario != "Custom Input":
    ...
    scenario_data = {
        "wind":10, "temp":20, "age":30,
        "humidity":60, "rain":25,
        "health":3.0, "belt":False
    }
